...
const PurchasesByProject = (props) => {
  const {t} = useTranslation();
  document.title = "GC Staffing - Purchases By Project"
  ...
  useEffect(()=>{
    dispatch(onTitleEdit('purchasesByProject'));
    dispatch(onBreadcrumbEdit(['inventory', 'reports', 'purchasesByProject']));
  },[dispatch]);
...
export default PurchasesByProject