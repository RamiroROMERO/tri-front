...
const ModalReviewUpdateRates = ({ setOpen, data, t }) => {
  const { customerId, weekId, projectSelected, enableUpdate, sweetAlerts, setLoading, fnGetData } = data;
  const { table, fnUpdateRates } = useModalReviewUpdateRates({ customerId, weekId, projectSelected, t, enableUpdate, sweetAlerts, setOpen, setLoading, fnGetData });
