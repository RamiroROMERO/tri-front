...
import { useModalCiaAccounts } from './useModalCiaAccounts';

export const ModalCiaAccounts = ({setOpen, data, t}) => {
  const {dataCiaAccounts, setLoading, sweetAlerts, getData} = data;

  const {table, formState, formValidation, isFormValid, sendForm, openMsgDelete, setOpenMsgDelete, onInputChange, fnSaveDocto, fnNewDocto, fnOkDelete} = useModalCiaAccounts({t, setLoading, sweetAlerts, dataCiaAccounts, getData});
