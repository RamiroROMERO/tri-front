...
const ForgotPassword = () => {
  ...
  document.title = "Forgot Password - GC Staffing"
  ...
  return (
    <Div sx={{
      ...
      <Card sx={{ maxWidth: '100%', width: 360, mb: 4 }}>
        <Div sx={{ position: 'relative', height: '200px' }}>
          <CardMedia
            ...
            alt="green iguana"
            height="200"
            image={getAssetPath(`${ASSET_IMAGES}/widgets/back-forgot-pass.jpg`)}
          />
          <Div sx={{
            flex: 1,
            inset: 0,
      ...
      <Typography variant={"body1"} mb={2}>Shared in Social Network</Typography>
